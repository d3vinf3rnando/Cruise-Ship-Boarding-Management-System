//software development 2 course work task 3
    ...
    public static void main(String[]args){
                ...
                O: View passengersOrdered alphabetically by name""");
                    ...
                    if (userInputLetter.equals("V") || userInputLetter.equals("v")){
                        ...
                        System.out.println(customerName); //add kare ai kiyala mataka na bng
                        System.out.println(customerCabinNumber); // add kare ai kiyala mataka na bng 2
                        ...
                        if (cabin_1.contains(delCustomerName)) {
                            ...
                            cabin_10.add(waitingList.get(0));
                            waitingList.remove(0);
                            ...
                            cabin_11.add(waitingList.get(0));
                            waitingList.remove(0);
                            ...
                            cabin_12.add(waitingList.get(0));
                            waitingList.remove(0);
                    ...
                    System.out.println(Arrays.asList(cabin_1));// remove later
                    System.out.println(Arrays.asList(cabin_12)); //remove later
                } //end  main while loop
            }
